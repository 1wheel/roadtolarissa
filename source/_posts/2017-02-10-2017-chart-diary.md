...
The Senate Librarian maintains a [https://imgur.com/oAyl3kO](doc with each cabinet appointment). Just scrolling through the data, I was surprised at how recently confirmations hearings had become contentious during a president's first year. 

To show that, I tried a [histogram](https://imgur.com/H7LGK8e), but there were so many  

I tried using a force layout to show every first year nomination    
