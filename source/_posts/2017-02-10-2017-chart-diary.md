...
I learned a ton from [chartsnthings](http://kpq.github.io/chartsnthings/) (despite )
...
<!-- <div><div><img src="img/0.png" class=""></div></div> -->
...
d3.selectAll('a').each(function(){
	...
	sel
		...
		.on('mouseover', () => sel.st({zIndex: zIndex++}))
