...
Jon picked apart [sound files](https://i.imgur.com/vA08o9k.png) to pick out when each gun shot occurred. We considered using the sound of each gunshot, but filtering out the background noise was too difficult, so I started toying around with webaudio. 
