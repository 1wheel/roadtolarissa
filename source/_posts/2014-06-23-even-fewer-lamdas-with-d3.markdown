...
---
Writing d3 typically involves writing lots of anonymous functions. The [scatter plot](http://blocks.roadtolarissa.com/mbostock/3887118) example illustrates two typical use cases: scales and attributes.  
