...
About 30 seconds after walking back into the office post paternity leave, Tom grabbed me: "Do you have a minute? We want to look at Democratic primary turnout this cycle."

I put my bag down and started pulling party turnout numbers from Secretary of State websites. The change in statewide turnout looked interesting, but there wasn't quite enough there to hang a story on. Getting the numbers for each was also difficult. The mechanics of party registration vary state to state, and states that did breakdown turnout by party were slow to post results. So we tried counting voters by just summing votes for Democratic and Republican candidates. House races didn't work for this--lots of seats don't have a primary--but 
