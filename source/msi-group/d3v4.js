...
var attachTooltip = function(sel, tooltipSel, fieldFns){
  ...
  function ttMove(d){
    ...
    // tt.style('top', (topPos < 500 ? 18 + y : topPos)+'px');
    // tt.style('left', x + 'px')
    tt.style('left', Math.min(Math.max(20, (x-nBB.width/2)), window.innerWidth - nBB.width)+'px');
    tt.style('top', (innerHeight - y > 200 ? y + 20 : y - nBB.height - 20 ) + 'px')
  }
